...
public enum TeamErrorCode implements ErrorCode {
    ...
    LAST_MANAGER_CANNOT_LEAVE(HttpStatus.CONFLICT, "LAST_MANAGER_CANNOT_LEAVE", "MANAGER가 한 명입니다. 역할을 이전한 후 변경하세요."),
    LAST_MANAGER_CANNOT_BE_REMOVED(HttpStatus.CONFLICT, "LAST_MANAGER_CANNOT_BE_REMOVED", "팀의 마지막 MANAGER는 제외할 수 없습니다."),
    CAPTAIN_ALREADY_ASSIGNED(HttpStatus.CONFLICT, "CAPTAIN_ALREADY_ASSIGNED", "이미 주장이 지정되어 있습니다."),
    PK_TAKER_ALREADY_ASSIGNED(HttpStatus.CONFLICT, "PK_TAKER_ALREADY_ASSIGNED", "이미 PK 키커가 지정되어 있습니다.");
